...
export default function Home() {
  return (
    <div class="body">
      ...
      <h1
        class="text-4xl text-black bg-slate-50
    p-4 mt-4 rounded-xl Welcome-logo"
      >
        The Synonym Game
      </h1>

      <div class="mt-8 p-4 d-flex">
        <button class="p-4 text-2xl bg-indigo-50 text-black rounded-xl mr-8  hover:scale-105 hover:bg-violet-200">
          Start Game
        </button>
